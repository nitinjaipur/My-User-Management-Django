"""
Django settings for userManagementBackend project.
...
WSGI_APPLICATION = 'userManagementBackend.wsgi.application'
...
# To store static files in a separate directory for production
